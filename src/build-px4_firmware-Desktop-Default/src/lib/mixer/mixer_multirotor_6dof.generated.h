...
enum class MultirotorGeometry : MultirotorGeometryUnderlyingType {
	...
	OCTA_COX_BOTTOM,               // GenericOctacopter in coax configuration (text key 8cb)
	OCTA_COX_TOP,                  // GenericOctacopter in coax configuration (text key 8ct)
...
const MultirotorMixer::Rotor _config_octa_cox_bottom[] = {
...
const MultirotorMixer::Rotor _config_octa_cox_top[] = {
	{ -0.353553,  0.353553,  5.000000,  0.000000,  0.000000, -0.250000 },
	{  0.353553,  0.353553, -5.000000,  0.000000,  0.000000, -0.250000 },
	{  0.353553, -0.353553,  5.000000,  0.000000,  0.000000, -0.250000 },
	{ -0.353553, -0.353553, -5.000000,  0.000000,  0.000000, -0.250000 },
...
const MultirotorMixer::Rotor *_config_index[] = {
	...
	&_config_hex_x[0],
	&_config_octa_cox[0],
	&_config_octa_cox_bottom[0],
	&_config_octa_cox_top[0],
